...
logtrain <- glm(default ~ balance, data = Default_train, family = binomial)
logtest <- glm(default ~ balance, data = Default_test,
          family = binomial)
logpredtrain<- ifelse(logtrain$fit < 0.5, "No", "Yes")
table(logpredtrain,Default_test$default)

testmselog <- (145 + 85) / (4768 + 145 + 85 +2)
1/nrow(Default_test)
